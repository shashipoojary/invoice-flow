    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white shadow-xl max-w-md w-full overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400 transition-colors"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-3 px-6 hover:bg-blue-700 transition-colors text-sm font-medium"
          >
            {isSignUp ? 'Create Account' : 'Sign In'}
          </button>
