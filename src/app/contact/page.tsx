          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <div className={`inline-flex items-center justify-center w-16 h-16 rounded-lg mb-6 ${
                ...
                <Mail className="w-8 h-8" style={{color: isDarkMode ? '#9ca3af' : '#6b7280'}} />
              </div>
              <h2 className="font-heading text-2xl sm:text-3xl font-bold mb-4" style={{color: isDarkMode ? '#f3f4f6' : '#1f2937'}}>
                Email Support
              </h2>
              <p className="text-lg mb-6" style={{color: isDarkMode ? '#9ca3af' : '#6b7280'}}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className={`p-8 rounded-lg border ${
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2" style={{color: isDarkMode ? '#f3f4f6' : '#1f2937'}}>
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-2" style={{color: isDarkMode ? '#f3f4f6' : '#1f2937'}}>
                    Message
                  </label>
                  <textarea
                    id="message"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className={`p-6 rounded-lg border ${
                ...
                <h3 className="font-heading text-lg font-bold mb-3" style={{color: isDarkMode ? '#f3f4f6' : '#1f2937'}}>
